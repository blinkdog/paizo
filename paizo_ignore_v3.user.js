...
function acceptAuthorHeader(element) {
    ...
    if(element.nodeName != "ITEMSCOPE") {
        return false;
    }
    if(element.getAttribute("itemprop") != "creator") {
        return false;
    }
    if(element.getAttribute("itemtype") != "http://schema.org/Person") {
        return false;
    }
    return true;
}
